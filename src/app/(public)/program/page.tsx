...
function PlenaryCard({
  ...
  return (
    <div className={`flex flex-col gap-6 p-6 lg:p-10 border-t-[3px] border-gold ${light ? "bg-white/[0.06]" : "bg-white"}`}>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col">
          <span className="font-[family-name:var(--font-body)] text-[12px] font-semibold tracking-[1px] uppercase text-gold">
            Moderator
          </span>
